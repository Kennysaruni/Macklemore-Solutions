  ...
  return (
    <div className="flex flex-col pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="space-y-24">
          {studies.map((study, i) => (
            <motion.div
              ...
              className="bg-navy-800 border border-white/5 rounded-3xl p-8 md:p-12"
            >
              <div className="flex flex-col md:flex-row gap-12">
                <div className="md:w-1/3">
                  ...
                  <div className="text-sm font-medium text-cyan-500 mb-2">Case Study {study.id}</div>
                  <h2 className="text-2xl font-display font-bold text-white mb-6">{study.title}</h2>
                  ...
                  <div className="space-y-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="text-white font-medium">{study.industry}</div>
                    </div>
                    {study.region && (
                      <div>
                        <div className="text-slate-500 mb-1">Region</div>
                        <div className="text-white font-medium">{study.region}</div>
                      </div>
                    )}
                    {study.size && (
                      <div>
                        <div className="text-slate-500 mb-1">Organization Size</div>
                        <div className="text-white font-medium">{study.size}</div>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="md:w-2/3 space-y-8">
                  <div>
                    <h3 className="text-lg font-display font-semibold text-white mb-3">Situation</h3>
                    <p className="text-slate-400 leading-relaxed">{study.situation}</p>
                  </div>
                  
                  <div>
                    <h3 className="text-lg font-display font-semibold text-white mb-3">Solution</h3>
                    <p className="text-slate-400 leading-relaxed mb-4">{study.solution}</p>
                    {study.deliverables && (
                  ...
                  <div className="bg-navy-900 border border-white/10 rounded-2xl p-6">
                    <h3 className="text-lg font-display font-semibold text-white mb-4">Impact</h3>
        ...
        <div className="mt-24 text-center bg-gradient-to-br from-navy-800 to-navy-900 border border-white/10 rounded-3xl p-12">
          <h2 className="text-2xl font-display font-bold text-white mb-4">Additional Case Studies</h2>
          ...
          <button className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-white text-navy-900 font-medium hover:bg-slate-100 transition-colors">
            Request Our Full Portfolio <ArrowRight className="w-4 h-4" />
          </button>
        </div>
      </div>
    </div>
