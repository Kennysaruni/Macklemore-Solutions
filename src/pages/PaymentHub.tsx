  ...
  return (
    <div className="flex flex-col pt-32 pb-24 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={{ visible: { transition: { staggerChildren: 0.1 } } }} className="grid md:grid-cols-3 gap-8 mb-24">
          <motion.div
            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
            whileHover={{ y: -8 }}
            className="bg-slate-50 border border-slate-200 rounded-2xl p-8 shadow-sm flex flex-col transition-shadow hover:shadow-md"
          >
          ...
          <motion.div
            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
            whileHover={{ y: -8 }}
            className="bg-brand-blue border border-brand-blue/20 rounded-2xl p-8 shadow-md flex flex-col text-white transition-shadow hover:shadow-lg"
          >
