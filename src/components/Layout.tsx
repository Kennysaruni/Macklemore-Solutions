                ...
                <div className="pt-3 space-y-3 text-xs text-slate-600 border-t border-slate-100">
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="space-y-1.5 leading-relaxed">
                      ...
                      <div>
                        <span className="font-semibold text-slate-800">Nigeria:</span> Horizon II Estate, Meadow Hallway, Ikate, Lagos, Nigeria <span className="text-slate-500 font-normal">(Office by appointment only)</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-2.5">
